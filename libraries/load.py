...
# perceptron
  # 2D---------------------------------
  # This function loads "features values per category" from a 2-dimensional pattern stack.  
def load_feats_values(tablename):
    # database connection
    ...
    # c1, c2: stands for category1 and category2 - x1,x2: stands for features 
    c1_x1 = []
    c1_x2 = []
    c2_x1 = []
    c2_x2 = []
    ...
    # print("Result for c2: \n",result_c2)
    # iteration creates 2 matrices for features x1,x2 that belong to category1            
    for row in result_c1:
        c1_x1.append(row[0])
        c1_x2.append(row[1])
    # iteration creates 2 matrices for features x1,x2 that belong to category2            
